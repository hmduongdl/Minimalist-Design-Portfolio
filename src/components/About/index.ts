        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 md:gap-10 lg:gap-24 items-stretch">
            ...
            <div id="about-left" class="bg-white/90 backdrop-blur-sm rounded-xl p-4 md:p-5 shadow-lg relative h-full flex flex-col transition-transform duration-700 overflow-hidden">
              ...
              <div class="flex justify-center gap-4 mt-auto">
                <a href="https://www.facebook.com/hmd.stewiclez" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full border-2 border-gray-300 flex items-center justify-center hover:border-clean-accent hover:text-clean-accent transition-all duration-300" aria-label="Facebook">
                  <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </a>
                <a href="https://github.com/hmduongdl" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full border-2 border-gray-300 flex items-center justify-center hover:border-clean-accent hover:text-clean-accent transition-all duration-300" aria-label="GitHub">
                ...
                <a href="mailto:hoanglong.workdl@gmail.com" class="w-10 h-10 rounded-full border-2 border-gray-300 flex items-center justify-center hover:border-clean-accent hover:text-clean-accent transition-all duration-300" aria-label="Email">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                </a>
                <a href="tel:+84911818016" class="w-10 h-10 rounded-full border-2 border-gray-300 flex items-center justify-center hover:border-clean-accent hover:text-clean-accent transition-all duration-300" aria-label="Phone">
